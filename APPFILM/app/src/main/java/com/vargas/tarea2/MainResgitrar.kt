...
class MainResgitrar : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapterAnio = ArrayAdapter.createFromResource(
            this,
            R.array.anio,
            android.R.layout.simple_spinner_item
        )
        ...
        binding.buttonResgistrar.setOnClickListener {
            ...
            AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.ok) { dialog, which ->
                    ...
                    Snackbar.make(binding.root, "Se han guardado los datos", Snackbar.LENGTH_SHORT)
                        .show()
                    //Vaciar los campos
            ...
            if (checkBox.isChecked) {
                ...
                //Eliminar despues de darl el chek
